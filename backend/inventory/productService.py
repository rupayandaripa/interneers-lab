...
class ProductServices:
    ...
    def fetch_all_products(page_number):
        ...
        return ProductRepository.objects.fetch_all_products_from_mongodb(page_number)
    ...
    @staticmethod
    def add_product(name, description, category, price, brand, quantity, isAvailable , created_at , updated_at):
